    ...
    <div className="about__container">
      ...
      <div className="culture__wrapper">
        ...
        <div className="culture__text__container">
          <h2>Our Culture</h2>
          <p>
            EasyCash believes in simplifying people's lives, be it customers or
            business owners. Our values represent a big part of out identity. we
            believe that innovation is the mean to a greater future, that's why
            our employees show a great deal of commitment and dedication,
            working as a one unit to achieve our mutual goals.
          </p>
        </div>
      </div>
    </div>
