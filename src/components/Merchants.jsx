        ...
        <div className="consumer__secondary">
          <div className="consumer__howto" style={{ display: "none" }}>
            <div className="consumer__howto__text">
              <h3>Restaurants</h3>
              <p>
                Offer your guest a unique user experience, start accepting
          ...
          <div className="consumer__howto">
            <div className="consumer__howto__text">
              <h3>Delivery</h3>
              <p>
                Delivery payment became easier by just letting your customer
          ...
          <div className="consumer__howto">
            <div className="consumer__howto__text">
              ...
              <p>
                ...
                face in your ride. You can now receive your money directly to
                your EasyCash wallet
              </p>
              <a href="/">
                Learn More <i className="fas fa-arrow-right"></i>
              </a>
